...
- Skapat `release/v0.8.5/` med aktuella printfiler och centrala speldokument.
...
- Strukturerat release-printfiler i `release/v0.8.5/print/svg/` och `release/v0.8.5/print/pdf/`.
...
- Regenererad release `release/v0.8.5/` med uppdaterade SVG- och PDF-filer.
...
- Lagt PDF och uppdaterad markdown-källa i `release/v0.8.5/docs/`.
...
- Regenererade `release/v0.8.5/docs/rulebook.pdf`.
