...
- Senaste rekommenderade release för utskrift är `release/v0.8.5/`.
- A6-kort och spelplan finns nu också i toner-snål ink-friendly-variant.

Regelboken finns nu som PDF i `release/v0.8.5/docs/rulebook.pdf`, genererad från `docs/rulebook.md` med Pandoc/XeLaTeX.
