...
- `docs/rulebook-clarity-analysis-v0.8.7.md`


## Regelboksrensning v0.8.7
...
## GitHub Actions dependency fix v0.8.7

Preview- och release-workflowen installerar nu även `lmodern`.
Det löser felet `LaTeX Error: File 'lmodern.sty' not found` när regelboks-PDF byggs med Pandoc/XeLaTeX på GitHub-runnern.
