...
- Skapade `release/v0.8.6/` med aktuella printfiler och centrala dokument.
- Lade till `PROJECT_STRUCTURE.md`.

## v0.7.9 – PDF release output

- Genererade PDF-versioner av spelplan, referenskort och kortark.
- Delade upp `release/v0.8.6/print/` i `svg/` och `pdf/`.
- Uppdaterade `release/v0.8.6/README.md` och `RELEASE_MANIFEST.json`.
...
- Genererade `release/v0.8.6/docs/rulebook.pdf` med Pandoc/XeLaTeX.
